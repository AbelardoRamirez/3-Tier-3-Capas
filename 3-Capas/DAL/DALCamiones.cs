...
namespace _3_Capas.DAL
{
    public class DALCamiones
    {
        ...
        //
        public static void InsertCamion(string Matricula, string TipoCamion, int Modelo, string Marca, int Capacidad, float Kilometraje, string UrlFoto)
        {
            try
            {
                //varibblee de tip string donde vamos a 
                string Query = "InsertCamion";
                //instancia de 
        ...
        public static void UpdateCamion(int IdCamion, string Matricula, string TipoCamion, int Modelo, string Marca, int Capacidad, float Kilometraje, bool Disponibilidad, string UrlFoto)
        {
            try
            {
                //varibblee de tip string donde vamos a 
                string Query = "UpdateCamion";
                //instancia de 
                SqlCommand cmd = new SqlCommand(Query, con);
                // indiga que es un strore prcedudee
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static void DeleteCamion(int IdCamion)
        {
            try
            {
                //varibblee de tip string donde vamos a 
                string Query = "DeleteCamion";
                //instancia de 
                SqlCommand cmd = new SqlCommand(Query, con);
                // indiga que es un strore prcedudee
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static CamionVO GetGetCamionById(int IdCamion)
        {
            try
            {
                //varibblee de tip string donde vamos a 
                string Query = "GetGetCamionById";
                //instancia de 
                SqlCommand cmd = new SqlCommand(Query, con);
